...
cron:32 4,22 14-29 4 *
============Quantumultx===============
[task_local]
#4.13~4.29 早鸟焕春 大牌惠聚
32 4,22 14-29 4 * jd_opencardL116.js, tag=4.13~4.29 早鸟焕春 大牌惠聚, enabled=true
...
!(async () => {
  ...
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/april/springUnion3/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
    authorCodeList = [
        '5c7adce5cbf64f82b294c51011a68e62',
        'fd457d07808b47c0b1cb4db28db22be2',
        '77b90020138049938259a96bc5d894a9',
    ]
