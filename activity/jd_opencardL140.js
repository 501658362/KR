...
[task_local]
#5.12~5.20 吃货来袭 惠聚好食光
10 15 12-20 5 * jd_opencardL140.js, tag=5.12~5.20 吃货来袭 惠聚好食光, enabled=true
...
!(async () => {
    ...
    $.shareUuid = "e51c755712b640bbafc5f3ebef497db8"
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)

    for (let i = 0; i < cookiesArr.length; i++) {
        authorCodeList = [
            'e51c755712b640bbafc5f3ebef497db8',
            '4172a14268ef4cffb0cf50e209ad32c8',
            '6190312724464802a99458d5fc45755a',
        ];
