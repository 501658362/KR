...
cron:10 13 22-31/3,1-22/5 5,6 *
============Quantumultx===============
[task_local]
#5.21-6.22 倩碧邀请礼
10 13 22-31/3,1-22/5 5,6 * jd_opencardL153.js, tag=5.21-6.22 倩碧邀请礼, enabled=true
...
!(async () => {
    ...
    let shareUuidArr = ["838006a29c2f429b8bb4b88138621ef0","388d2b1ea8b241d6a8ae32b3202f81cf","e3ae084f4f554f3a8e679fc8a20aaf08"]
    $[_0x39d7('‫2b', '#nDa')] =  '838006a29c2f429b8bb4b88138621ef0';
    ...
    for (let _0x1c38d9 = 0x0; _0x1c38d9 < cookiesArr[_0x39d7('‮31', '$&@v')]; _0x1c38d9++) {
        if (_0x42407b[_0x39d7('‮32', 'FZqo')](_0x39d7('‮33', 'OsmU'), _0x42407b['JEzZW'])) {
            ...
            let n = Math.floor((Math.random()*shareUuidArr.length))
