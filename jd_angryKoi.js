...
0 0,23 * * * https://raw.githubusercontent.com/cdle/jd_study/main/jd_angryKoi.js
*/
const $ = new Env("愤怒的锦鲤")
const JD_API_HOST = 'https://api.m.jd.com/client.action';
const ua = `jdltapp;iPhone;3.1.0;${Math.ceil(Math.random()*4+10)}.${Math.ceil(Math.random()*4)};${randomString(40)}`
var kois = "gaoyucindy@35153692-843702@lm_gaoyucindy@jd_48ad411b29d3d@%E7%A6%8F%E5%B7%9E%E4%BB%8A%E5%A8%B1@jd_cBpkASiSetDT@7050630-776007@jd_BPFnyOCgQADQ@jd_TyclndvqVlTZ"
let cookiesArr = []
var helps = [];
var tools= []
!(async () => {
    ...
    for (let i in cookiesArr) {
        ...
        tools.push({id: i, cookie: cookie,retry:0})
    }
