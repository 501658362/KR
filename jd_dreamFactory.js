...
===============Surge=================
京喜工厂 = type=cron,cronexp="10 0,6-23/4 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=jd_dreamFactory.js, cronexpr="10 0,6-23/4 * * *", timeout=3600, enable=true
