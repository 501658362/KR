...
[task_local]
#东东健康社区收集能量
5 * * * * jd_health_collect.js, tag=东东健康社区收集能量, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "5 * * * *" script-path=jd_health_collect.js, tag=东东健康社区收集能量

====================Surge================
东东健康社区收集能量 = type=cron,cronexp="5 * * * *",wake-system=1,timeout=3600,script-path=jd_health_collect.js

============小火箭=========
东东健康社区收集能量 = type=cron,script-path=jd_health_collect.js, cronexpr="5 * * * *", timeout=3600, enable=true
 */
