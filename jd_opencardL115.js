...
cron:34 6,21 14-20 4 *
============Quantumultx===============
[task_local]
#4.13~4.20 大牌好物 春日嗨购
34 6,21 14-20 4 * jd_opencardL115.js, tag=4.13~4.20 大牌好物 春日嗨购, enabled=true
...
!(async () => {
  ...
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
    authorCodeList = [
        'dd5b19a98dfd498b88d883fef91c6915',
        '2f8dabda96ec4fc9b6e1d0fa34ade48d',
        '34ed942f023d48d49dfc7a539e79b8a3',
    ]
